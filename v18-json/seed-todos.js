const todos = `[
  ...
  {
    "id": 13, "task": "Classes", "due": "", "done": true, "details": "Class declarations, static and instance properties and methods, and inheritance."
  },
  {
    "id": 14, "task": "Modules", "due": "", "done": true, "details": "CommonJS require and module.exports, import and export statements."
  },
  {
    "id": 15, "task": "Promises", "due": "", "done": true, "details": "Callback functions, existing promises, create promises, thenables, async/await."
  },
  {
    "id": 16, "task": "Web APIs", "due": "", "done": true, "details": "Console, timers, web storage, fetch."
  },
  {
    "id": 17, "task": "DOM", "due": "", "done": true, "details": "Select and minipulate nodes and elements, traverse the DOM, events, forms."
  },
  {
    "id": 18, "task": "JSON", "due": "", "done": false, "details": "JSON syntax, JSON global object, stringify and parse methods."
  }
]`;
console.log(`1 in the seed-todos.js file, change the format of the todo array from JavaScript to a template string in JSON format. JSON format uses double instead of single quotes. Property names are quoted.
