const todos = [
  ...
  {
    id: 14, task: 'Modules', due: '', done: false, details: 'CommonJS require and module.exports, import and export statements.',
  },
];

console.log(`2 Place the todos array in a separate file (a separate module). Export it using the export statement.
